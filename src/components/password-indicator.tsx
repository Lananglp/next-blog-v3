        ...
        <div className='bg-zinc-800 rounded-xl p-3 my-2'>
            <div className='mb-8 w-full h-2 bg-zinc-700 rounded-xl'>
                ...
                <div className='flex justify-between items-center mt-1'>
                    <span className={`${strength === 0 ? "text-zinc-500" : strength > 0 ? "text-zinc-300" : "text-zinc-300"} text-xs`}>Low</span>
                    <span className={`${strength >= 40 ? "text-zinc-300" : "text-zinc-500"} text-xs`}>Medium</span>
                    <span className={`${strength >= 70 ? "text-zinc-300" : "text-zinc-500"} text-xs`}>High</span>
                </div>
            </div>
