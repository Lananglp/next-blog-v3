            ...
            <section className="space-y-6">
                ...
                <div className="w-full flex flex-row gap-6">
                    <div className="max-w-3xl">
                        ...
                        <p className="mb-6 md:mb-8 text-3xl md:text-5xl leading-tight md:leading-tight font-semibold text-transparent bg-clip-text bg-gradient-to-r from-sky-700 dark:from-sky-300 to-black to-[50%] dark:to-white">Express Yourself Through Blogging: Unleash Your Creativity!</p>
                    ...
                    <div className="hidden w-full xl:flex justify-center items-center">
                        ...
                        <div className="ps-[1px] pt-[1px] bg-gradient-to-br from-sky-500 from-[0%] to-transparent to-[50%] rounded-lg">
                            <div className="h-full bg-gradient-to-br from-zinc-100 dark:from-zinc-900 from-[0%] to-white/25 dark:to-black/75 to-[100%] rounded-lg">
                                <SmallDemoEditor />
                            </div>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                    <div>
                        <div className="h-full ps-[1px] pt-[1px] bg-gradient-to-br from-sky-500 from-[0%] to-transparent to-[50%] rounded-lg">
                            <div className="flex flex-row xl:flex-col gap-x-6 h-full p-6 bg-gradient-to-br from-zinc-100 dark:from-zinc-900 from-[0%] to-white/25 dark:to-black/75 to-[100%] rounded-lg">
